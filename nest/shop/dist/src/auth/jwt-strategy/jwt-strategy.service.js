...
function cookieExtractor(req) {
    var _a;
    return ((_a = req === null || req === void 0 ? void 0 : req.cookies) === null || _a === void 0 ? void 0 : _a.jwt) ? req.cookies.jwt : null;
}
;
let JwtStrategyService = class JwtStrategyService extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy) {
    ...
    async validate(payload, done) {
        ...
        ;
        const user = await this.usersRepo.findOne({ currentToken: payload.id });
        if (!user) {
            done(new common_1.UnauthorizedException(), false);
        }
        ;
