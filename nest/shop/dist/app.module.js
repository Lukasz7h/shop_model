...
AppModule = __decorate([
    (0, common_1.Module)({
        imports: [stuff_module_1.StuffModule, auth_module_1.AuthModule, basket_module_1.BasketModule],
        controllers: [app_controller_1.AppController],
        providers: [app_service_1.AppService, valid_order_data_form_service_1.ValidOrderDataFormService],
    })
], AppModule);
